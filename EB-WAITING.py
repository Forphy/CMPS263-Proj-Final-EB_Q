...
csvread=open('EmploymentChina.csv','rb')
Employment = csv.reader(csvread)
with open('Employment_process_China.csv','wb') as f:
  writer=csv.writer(f)
  writer.writerow(['Current_Year','Current_Month','1st_year','1st_month','EB1_month_diff','2nd_year','2nd_month','EB2_month_diff','3rd_year','3rd_month','EB3_month_diff'])
